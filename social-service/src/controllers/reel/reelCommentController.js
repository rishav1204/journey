import {
  ...
  deleteReplyService,
} from "../../services/reels/reelCommentServices.js";

export const getComments = async (req, res) => {
  try {
    const { reelId } = req.params;
    const comments = await getCommentsService(reelId, "Reel");
...
export const createComment = async (req, res) => {
  try {
    ...
    const comment = await createCommentService(reelId, userId, content, "Reel");
